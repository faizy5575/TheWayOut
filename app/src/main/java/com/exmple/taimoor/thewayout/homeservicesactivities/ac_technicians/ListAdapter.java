package com.exmple.taimoor.thewayout.homeservicesactivities.ac_technicians;
...
public class ListAdapter extends BaseAdapter
{
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        if(convertView == null)
        {
            ...
            convertView = layoutInfiater.inflate(R.layout.actech, null);

            viewItem.SubNameTextView = convertView.findViewById(R.id.actechText1);

            viewItem.SubFullFormTextView = convertView.findViewById(R.id.actechText2);

            viewItem.SubFullFormPhoneNumber = convertView.findViewById(R.id.actechText3);
