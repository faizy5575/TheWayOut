package com.exmple.taimoor.thewayout.homeservicesactivities.painter;
...
public class ListAdapter extends BaseAdapter
{
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        if(convertView == null)
        {
            ...
            convertView = layoutInfiater.inflate(R.layout.paint, null);

            viewItem.SubNameTextView = convertView.findViewById(R.id.paintText1);

            viewItem.SubFullFormTextView = convertView.findViewById(R.id.paintText2);

            viewItem.SubFullFormPhoneNumber = convertView.findViewById(R.id.paintText3);
