package com.exmple.taimoor.thewayout.homeservicesactivities.cleaner;
...
public class ListAdapter extends BaseAdapter
{
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        if(convertView == null)
        {
            ...
            convertView = layoutInfiater.inflate(R.layout.clean, null);

            viewItem.SubNameTextView = convertView.findViewById(R.id.cleanText1);

            viewItem.SubFullFormTextView = convertView.findViewById(R.id.cleanText2);

            viewItem.SubFullFormPhoneNumber = convertView.findViewById(R.id.cleanText3);
