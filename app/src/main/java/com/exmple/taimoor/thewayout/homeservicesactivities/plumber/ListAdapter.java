package com.exmple.taimoor.thewayout.homeservicesactivities.plumber;
...
public class ListAdapter extends BaseAdapter
{
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        if(convertView == null)
        {
            ...
            convertView = layoutInfiater.inflate(R.layout.plumb, null);

            viewItem.SubNameTextView = convertView.findViewById(R.id.plumbText1);

            viewItem.SubFullFormTextView = convertView.findViewById(R.id.plumbText2);

            viewItem.SubFullFormPhoneNumber = convertView.findViewById(R.id.plumbText3);
