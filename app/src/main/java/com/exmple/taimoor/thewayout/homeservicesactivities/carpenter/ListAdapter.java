...
public class ListAdapter extends BaseAdapter
{
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        if(convertView == null)
        {
            ...
            convertView = layoutInfiater.inflate(R.layout.carpent, null);

            viewItem.SubNameTextView = convertView.findViewById(R.id.carpentText1);

            viewItem.SubFullFormTextView = convertView.findViewById(R.id.carpentText2);

            viewItem.SubFullFormPhoneNumber = convertView.findViewById(R.id.carpentText3);
