...
public class ListAdapter implements android.widget.ListAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        if(convertView == null)
        {
            ...
            convertView = layoutInfiater.inflate(R.layout.list_view_for_dealsactivity, null);
        ...
        viewItem.SubNameTextView.setText(subject_list.get(position).amount);

        viewItem.SubFullFormTextView.setText(subject_list.get(position).image);
