package com.exmple.taimoor.thewayout.homeservicesactivities.laundry;
...
public class ListAdapter extends BaseAdapter
{
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        if(convertView == null)
        {
            ...
            convertView = layoutInfiater.inflate(R.layout.laund, null);

            viewItem.SubNameTextView = convertView.findViewById(R.id.laundText1);

            viewItem.SubFullFormTextView = convertView.findViewById(R.id.laundText2);

            viewItem.SubFullFormPhoneNumber = convertView.findViewById(R.id.laundText3);
