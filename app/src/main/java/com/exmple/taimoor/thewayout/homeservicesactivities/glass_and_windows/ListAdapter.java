...
public class ListAdapter extends BaseAdapter
{
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        if(convertView == null)
        {
            ...
            convertView = layoutInfiater.inflate(R.layout.glass_and_windows, null);

            viewItem.SubNameTextView = convertView.findViewById(R.id.glassText1);

            viewItem.SubFullFormTextView = convertView.findViewById(R.id.glassText2);

            viewItem.SubFullFormPhoneNumber = convertView.findViewById(R.id.glassText3);
