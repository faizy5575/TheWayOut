...
public class construction extends AppCompatActivity {
    ...
    String HttpURL = "http://192.168.53.118:80/theWayOut/construction.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SubjectFullFormListView = (ListView) findViewById(R.id.constructListView);

        progressBar = (ProgressBar) findViewById(R.id.constructProgressBar1);
