...
public class ListAdapter extends BaseAdapter
{
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        if(convertView == null)
        {
            ...
            viewItem.SubFullFormTextView = convertView.findViewById(R.id.electricianText2);

            viewItem.SubFullFormPhoneNumber = convertView.findViewById(R.id.electricianText3);
