package com.exmple.taimoor.thewayout.homeservicesactivities.construction;
...
public class ListAdapter extends BaseAdapter
{
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        if(convertView == null)
        {
            ...
            convertView = layoutInfiater.inflate(R.layout.construct, null);

            viewItem.SubNameTextView = convertView.findViewById(R.id.constructText1);

            viewItem.SubFullFormTextView = convertView.findViewById(R.id.constructText2);

            viewItem.SubFullFormPhoneNumber = convertView.findViewById(R.id.constructText3);
