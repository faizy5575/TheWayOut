...
public class painter extends Activity {
    ...
    String HttpURL = "http://192.168.51.139:8080/theWayOut/painter.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SubjectFullFormListView = (ListView) findViewById(R.id.paintListView);

        progressBar = (ProgressBar) findViewById(R.id.paintProgressBar1);
