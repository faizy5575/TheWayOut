package com.exmple.taimoor.thewayout.homeservicesactivities.drivers;
...
public class ListAdapter extends BaseAdapter
{
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        if(convertView == null)
        {
            ...
            convertView = layoutInfiater.inflate(R.layout.drive, null);

            viewItem.SubNameTextView = convertView.findViewById(R.id.driveText1);

            viewItem.SubFullFormTextView = convertView.findViewById(R.id.driveText2);

            viewItem.SubFullFormPhoneNumber = convertView.findViewById(R.id.driveText3);
