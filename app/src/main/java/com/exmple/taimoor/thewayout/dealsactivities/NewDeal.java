        ...
        try {
            class AsyncTaskUploadClass extends AsyncTask<Void,Void,String> {
                ...
                protected void onPreExecute() {
                    ...
                    // Toast.makeText(NewDeal.this, "Image is uploading", Toast.LENGTH_SHORT).show();

                    progressDialog = ProgressDialog.show(NewDeal.this,"Image is Uploading","Please Wait",false,false);
                }
                ...
                protected void onPostExecute(String string1) {
                    ...
                    Toast.makeText(NewDeal.this, string1, Toast.LENGTH_LONG).show();

                    Intent intent = new Intent(NewDeal.this, DealsActivity.class);
